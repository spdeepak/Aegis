     ...
     new_permissions AS (
         INSERT INTO permissions (name, description, created_by, updated_by)
             VALUES ('roles:create', 'Permission to create roles', 'system', 'system'),
                    ...
                    ('users:lock', 'Permission to lock users', 'system', 'system'),
                    ('users:unlock', 'Permission to unlock users', 'system', 'system'),
                    ('users:disable', 'Permission to disable users', 'system', 'system'),
                    ('users:enable', 'Permission to enable users', 'system', 'system'),
